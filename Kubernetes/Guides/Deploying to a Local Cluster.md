...
---
The first portion of the file is the definition that kubernetes will use for determining the kind of deployment, what api version to use, and the metadata related to the file.
